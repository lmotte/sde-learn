...
n_paths_tr = 1000  # Number of train paths to draw
n_paths_te = 100  # Number of test paths to draw


# Drift and diffusion coefficients.
b, sigma_func = gaussian(
    t1=0,
    x1=np.array([0, 0]),
    t2=1.0,
    x2=np.array([1, 0]),
...
plot_paths_2d(
    X_tr[:n_plot],
    save_path="../plots/test_sde_identification_2d_1/true_samples.pdf",
)
...
plot_map_2d(
    ...
    alt_label=r"$t$",
    map_v=p_pred_grid,
    save_path="../plots/test_sde_identification_2d_1/",
    T_plot=T_tr,
    X_plot=X_tr,
)
...
plot_paths_2d(paths_samp, save_path="../plots/test_sde_identification_2d_1/samples.pdf")


# Compute and plot mean and variance of true SDE w.r.t. time.
mean = np.mean(X_tr, axis=0)
std = np.std(X_tr, axis=0)
save_path = "../plots/test_sde_identification_2d_1/mean_sample_true.pdf"
line_plot(
    mean[:, 0], mean[:, 1], save_path, title=r"$\mu(t)$", xlabel="$x_1$", ylabel="$x_2$"
)
save_path = "../plots/test_sde_identification_2d_1/std_sample_true.pdf"
line_plot(
    std[:, 0],
    std[:, 1],
    save_path,
...
save_path = "../plots/test_sde_identification_2d_1/mean_sample_es.pdf"
line_plot(
    mean[:, 0],
    mean[:, 1],
    save_path,
...
save_path = "../plots/test_sde_identification_2d_1/std_sample_es.pdf"
line_plot(
    std[:, 0],
    std[:, 1],
    save_path,
